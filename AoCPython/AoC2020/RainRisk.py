class RainRisk():
    ...
    def compass_waypoint(self,direction, turn_degree, inverted=None):
        if inverted is None:
            if direction == self.north_val:
                if turn_degree == 90:
                    self.waypoint_east = 10
                    self.waypoint_north = 4
                elif turn_degree == 180:
                    self.waypoint_south = 10
                    self.waypoint_east = 4
                elif turn_degree == 270:
                    self.waypoint_west = 10
                    self.waypoint_south = 4
            ...
            if direction == self.east_val:
                if turn_degree == 90:
                    ...
                    self.waypoint_north = 10
                    self.waypoint_west = 4
