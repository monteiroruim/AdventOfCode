class d1:
    ...
    def __init__(self, modulesMass):
        '''
        constructor
        aircraft_modules is a set o exercice given values (different per case)
        [118474,89187,55404,99729,110519,105939,97881,134416,121399,85572,96223,121830,116952,51791,54990,87574,124293,
        ...
        '''
        self.aircraft_modules = modulesMass
        self.total_fuel = 0
    ...
    def get_total_fuel_2(self):
        for mass in self.aircraft_modules:
            ...
            while module_active:
                if self.get_module_fuel(init_module) > 0:
